		...
		<div  onload="myFunction();"
			style="height: 74%; width: 98%; position: absolute; border: 1px solid rgba(18, 27, 27, 0.51); border-radius: 5px; margin: 5px 5px 5px 5px;">
				...
				<div style="border-radius: 25px; border: 1px solid #d6d6c2; padding: 5px; font-family: Verdana; font-size: 12px;" >
        			...
        			<a href='<c:url value = "/highLowReportFullSellClosable"/>'>Sell Only+CLOSE</a>&nbsp;&nbsp;&nbsp;;&nbsp;
        			<a href='<c:url value = "/highLowReportFullSell"/>'>Sell Only</a>&nbsp;&nbsp;&nbsp;
					<a href='<c:url value = "/highLowReportFullBuy"/>'>Buy Only</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        			
        			${totalTrades} <span
					style="font: normal; font-family: sans-serif; color: light-blue;">Full Day Report </span>
        			&nbsp;&nbsp;<a href='<c:url value = "/highLowReportFull"/>'><img
					align="top" src="<c:url value="/images/refresh.png"/>" /></a>
        			${profitLoss}
        			
        			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='<c:url value = "/highLowReportFullProfit"/>'>Profits Only</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        			<a href='<c:url value = "/highLowReportFullLoss"/>'>Losses Only</a>&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;
        			<a href='<c:url value = "/highLowReportFullBuyClosable"/>'>BUY Only+CLOSE</a>
        		</div>
        		</div>
        		<div class="container"
				style="width: 99%; max-height: 92%; overflow-x: scroll; padding-left: 10px;">
					...
					<table style="min-height: 90%; width: 100%;" class=" " id="mytable">
						...
						varStatus="status">
							<tr>
								<td align="center"><a href='<c:url value = "/stockDetails?stockId=${highLowBean.stockId}"/>'>${highLowBean.stockName}</a></td>
