		...
		<div
			style="height: 74%; width: 98%; position: absolute; border: 1px solid rgba(18, 27, 27, 0.51); border-radius: 5px; margin: 5px 5px 5px 5px;">
				...
				<div style="border-radius: 25px; border: 1px solid #d6d6c2; padding: 5px; font-family: Verdana; font-size: 12px;" >
        			...
        			<a href='<c:url value = "/buyCprCloseTrades"/>'>BUY CPR+CLOSE</a>&nbsp;&nbsp;
        			<a href='<c:url value = "/buyCprTrades"/>'>BUY CPR</a>&nbsp;&nbsp;
					<a href='<c:url value = "/sellCprTrades"/>'>SELL CPR</a>&nbsp;&nbsp;&nbsp;
        			
        			${totalTrades} <span
					style="font: normal; font-family: sans-serif; color: light-blue;"> ${strategy_title} </span>
        			&nbsp;&nbsp;<a href='<c:url value = "/nr4Trades"/>'><img
					align="top" src="<c:url value="/images/refresh.png"/>" /></a>
        			${profitLoss}
        			
        			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        			<a href='<c:url value = "/buyNotCprTrades"/>'>BUY NOT CPR</a>&nbsp;&nbsp;&nbsp;
        			<a href='<c:url value = "/sellNotCprTrades"/>'>SELL NOT CPR</a>&nbsp;&nbsp;&nbsp;;&nbsp;
        			<a href='<c:url value = "/sellNotCprCloseTrades"/>'>SELL NOT CPR+CLOSE</a>
        		</div>
        		</div>
        		<div class="container"
