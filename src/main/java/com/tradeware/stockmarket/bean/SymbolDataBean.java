...
public class SymbolDataBean extends AbstractDataBean {

	private static final long serialVersionUID = 8875204065734159878L;
	...
	private String optionChaninTrend;
	public String getOptionChaninTrend() {
		return optionChaninTrend;
	}
	public void setOptionChaninTrend(String optionChaninTrend) {
		this.optionChaninTrend = optionChaninTrend;
	}
